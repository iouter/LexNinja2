...
public class BlackDragonHand() : LexNinja2Card(0,
    CardType.Skill, CardRarity.Uncommon,
    TargetType.AnyEnemy)
{
    protected override IEnumerable<DynamicVar> CanonicalVars => [new DynamicVar("HP",2),new NinjutsuVar(2),new PowerVar<WeakPower>(2)];
    protected override IEnumerable<IHoverTip> ExtraHoverTips => [HoverTipFactory.FromPower<IntangiblePower>(), HoverTipFactory.FromPower<WeakPower>()];
        ...
        CardPlay play)
    {
        ...
        if (Ninjutsu())
        {
            ...
            await CreatureCmd.LoseMaxHp(choiceContext, play.Target,DynamicVars["HP"].BaseValue,true);
