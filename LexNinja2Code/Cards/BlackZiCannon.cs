...
public class BlackZiCannon() : LexNinja2Card(4,
    ...
    TargetType.AnyEnemy)
{
        ...
        CardPlay play)
    {
        ...
        {
            NLargeMagicMissileVfx child = NLargeMagicMissileVfx.Create(creatureNode.GetBottomOfHitbox(), new Godot.Color("50b598"));
        ...
        await DamageCmd.Attack(DynamicVars.Damage.BaseValue).FromCard(this).Targeting(play.Target).WithHitFx( tmpSfx: "blunt_attack.mp3").Execute(choiceContext);
    }
