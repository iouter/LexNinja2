...
public class GoodNight() : LexNinja2Card(0,
    ...
    TargetType.Self)
{
        ...
        CardPlay play)
    {
        ...
        await PowerCmd.Apply<GoodNightPower>(new ThrowingPlayerChoiceContext(), Owner.Creature, healPoint, Owner.Creature, this);
