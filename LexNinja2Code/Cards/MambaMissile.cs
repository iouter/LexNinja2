...
public class MambaMissile() : LexNinja2Card(3,
    ...
    TargetType.RandomEnemy)
{
        ...
        CardPlay play)
    {
        ...
        await DamageCmd.Attack(DynamicVars.Damage.BaseValue).WithHitCount(DynamicVars.Repeat.IntValue).FromCard(this).TargetingRandomOpponents(CombatState).WithHitFx("vfx/vfx_rock_shatter", tmpSfx: "blunt_attack.mp3").WithHitVfxSpawnedAtBase().Execute(choiceContext);
