...
public class MummyMummy() : LexNinja2Card(1,
    ...
    TargetType.Self)
{
        ...
        CardPlay play)
    {
        ...
        await PowerCmd.Apply<MummyPower>(new ThrowingPlayerChoiceContext(), Owner.Creature, DynamicVars["Power"].BaseValue, Owner.Creature, this);
    }
