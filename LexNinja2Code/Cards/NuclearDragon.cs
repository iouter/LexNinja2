...
public class NuclearDragon() : LexNinja2Card(1,
    ...
    TargetType.Self)
{
        ...
        CardPlay play)
    {
        ...
        await PowerCmd.Apply<NuclearDragonPower>(new ThrowingPlayerChoiceContext(), Owner.Creature,DynamicVars["Power"].BaseValue,Owner.Creature,this);
    }
