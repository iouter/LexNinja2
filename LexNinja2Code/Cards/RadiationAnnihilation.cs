...
public class RadiationAnnihilation() : LexNinja2Card(6,
    ...
    TargetType.AllEnemies)
{
        ...
        CardPlay play)
    {
        ...
        await PowerCmd.Apply<Radiation>(new ThrowingPlayerChoiceContext(), CombatState.HittableEnemies, 25, Owner.Creature, this);
    }
