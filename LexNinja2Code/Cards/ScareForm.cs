...
public class ScareForm() : LexNinja2Card(3,
    CardType.Power, CardRarity.Rare,
    TargetType.Self)
{
    protected override IEnumerable<DynamicVar> CanonicalVars => [new PowerVar<ScarePower>(1),new NinjutsuVar(0)];
        ...
        CardPlay play)
    {
        ...
        await PowerCmd.Apply<ScarePower>(new ThrowingPlayerChoiceContext(), Owner.Creature,DynamicVars.Power<ScarePower>().BaseValue,Owner.Creature,this);
    }
