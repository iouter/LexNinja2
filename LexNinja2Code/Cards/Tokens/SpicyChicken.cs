...
public class SpicyChicken() : LexNinja2Card(0,
    ...
    TargetType.Self)
{
        ...
        CardPlay play)
    {
        ...
        await PowerCmd.Apply<FlexPotionPower>(new ThrowingPlayerChoiceContext(), Owner.Creature, DynamicVars.Power<FlexPotionPower>().BaseValue,
            Owner.Creature, this);
    }
