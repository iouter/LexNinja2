...
public class WePeace() : LexNinja2Card(1,
    CardType.Skill, CardRarity.Uncommon,
    TargetType.Self)
{
    protected override IEnumerable<DynamicVar> CanonicalVars => [new PowerVar<IntangiblePower>(1),new NinjutsuVar(1)];
    public override IEnumerable<CardKeyword> CanonicalKeywords => [CardKeyword.Ethereal];
    protected override HashSet<CardTag> CanonicalTags => [NinjaTags.Ninjutsu];
    protected override IEnumerable<IHoverTip> ExtraHoverTips => [HoverTipFactory.FromPower<IntangiblePower>(),HoverTipFactory.FromPower<Lexkela>()];
        ...
        CardPlay play)
    {
        if (Ninjutsu())
        {
            ...
            await PowerCmd.Apply<WePeacePower>(new ThrowingPlayerChoiceContext(), Owner.Creature,1, Owner.Creature, this);
