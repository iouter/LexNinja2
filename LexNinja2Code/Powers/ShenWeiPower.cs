...
public class ShenWeiPower : CustomPowerModel
{
    ...
    public override async Task AfterCardPlayed(PlayerChoiceContext context, CardPlay cardPlay)
    {
        ...
        {
            await PowerCmd.Apply <IntangiblePower> (new ThrowingPlayerChoiceContext(),Owner, -1, null, null);
        }
    }
    public override async Task AfterSideTurnStart(CombatSide side, ICombatState combatState)
    {
        ...
        Flash();
        await PowerCmd.Apply<IntangiblePower>(new ThrowingPlayerChoiceContext(), Owner, Amount, null, null);
